...
class ClipModelArguments:
    ...
    output_dim: int = field(default=512, metadata={"help": "Output dimension for features"})
    img_mlp_type: int = field(default=1, metadata={"help": "Image MLP type"})
    txt_mlp_type: int = field(default=1, metadata={"help": "Text MLP type"})

...
MODEL_PATH="/mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/2025-09-13/qwen_lora_new_clip_version10/merged"
...
# 结果输出路径
RESULT_DIR="$BASE_DIR/results/2025-09-13/clip_eval_experiments_v10"
mkdir -p $RESULT_DIR

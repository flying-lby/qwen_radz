...
MODEL_PATH="/mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/2025-09-13/qwen_lora_new_clip_version12/merged"
...
# 结果输出路径
RESULT_DIR="$BASE_DIR/results/2025-09-13/clip_eval_experiments_v12"
mkdir -p $RESULT_DIR

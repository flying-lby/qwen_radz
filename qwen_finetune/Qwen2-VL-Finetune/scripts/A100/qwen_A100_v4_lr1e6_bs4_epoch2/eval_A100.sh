...
MODEL_PATH="/mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/qwen_lora_new_clip_version4/merged"
...
# 结果输出路径
RESULT_DIR="$BASE_DIR/results/clip_eval_experiments_v4"
mkdir -p $RESULT_DIR

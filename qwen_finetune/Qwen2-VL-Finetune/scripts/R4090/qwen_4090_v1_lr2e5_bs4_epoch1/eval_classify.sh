...
BASE_CMD="python -m src.eval.clip_eval \
    --model_path $MODEL_PATH \
    --data_path /home/lby/iclr2026/llava_med/LLaVA-Med/llava/run/data/chest_xray/Chest-X-ray_llava_origin_val.jsonl \
    --image_folder $IMAGE_FOLDER \
    --dataset chestxray \
    --batch_size $BATCH_SIZE \
    --output_path $RESULT_DIR/chestxray14_clip_results.json \
...
BASE_CMD="python -m src.eval.clip_eval \
    --model_path $MODEL_PATH \
    --data_path /home/lby/iclr2026/llava_med/LLaVA-Med/llava/run/data/chexpert/chexpert_llava_origin_val.jsonl \
    --image_folder $IMAGE_FOLDER \
    --dataset chexpert \
    --batch_size $BATCH_SIZE \
    --output_path $RESULT_DIR/chexpert_clip_results.json \
